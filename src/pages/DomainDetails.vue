...
const domain = computed(() =>
  domainScope.value?.expose.data?.status === SUCCESS_FETCHING_STATUS ? domainScope.value.expose.data.data : undefined
);
...
const assets = computed(() =>
  assetsListScope.value?.expose.data?.status === SUCCESS_FETCHING_STATUS
...
const NFTs = computed(() =>
  NFTsListScope.value?.expose.data?.status === SUCCESS_FETCHING_STATUS ? NFTsListScope.value.expose.data.data.items : []
);
...
const accounts = computed(() =>
  accountsListScope.value?.expose.data?.status === SUCCESS_FETCHING_STATUS
